...
class SignupView(View):
    ...
    def post(self, request, **kwargs):
        ...
        if user_exists:
            add_message(request, messages.WARNING, message=_(
                "Il semblerait que vous ayez déjà un compte chez nous"))
...
class LoginView(View):
    def get(self, request, *args, **kwargs):
        context = {'form': UserLoginForm, 'form_button_registration': _('Se connecter')}
...
class ForgotPasswordView(View):
    ...
    def post(self, request, **kwargs):
        ...
        if form.is_valid():
            ...
            if user.exists():
                form.save(from_email='support.kurrikulam@gmail.com', email_template_name='registration/forgot_password.html')

            else:
                form.errors['email'] = _("Nous n'avons pas pu vous trouvez")
                context = {
                    'form': PasswordResetForm,
                    'form_button_registration': _('Nouveau mot de passe')
                }
